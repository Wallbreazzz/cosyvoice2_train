#!/bin/bash
# =============================================================================
# Phase 4: LoRA fine-tune LLM (Qwen2) for CosyVoice2
#
...
#   3. Launches torchrun for LoRA fine-tuning of LLM
# =============================================================================
...
echo "============================================================"
echo "  Phase 4: LoRA Fine-tune LLM (Qwen2)"
echo "============================================================"
echo ""
...
if [ ! -f "$PRETRAINED/llm.pt" ]; then
    echo "ERROR: $PRETRAINED/llm.pt not found"
    echo "Please ensure pretrained model is downloaded first"
    exit 1
fi
echo "  OK: llm.pt exists"
...
mkdir -p "$EXP_DIR"
mkdir -p "/home/mind/model/cosyvoice_train/exp/cosyvoice2/tensorboard/llm"
...
echo ""
echo "Configuration:"
echo "  Model: llm (Qwen2 with LoRA)"
...
torchrun --nnodes=1 --nproc_per_node=1 \
    --rdzv_id=1 --rdzv_backend="c10d" --rdzv_endpoint="localhost:1234" \
  ...
  --model_dir "$EXP_DIR" \
  --tensorboard_dir /home/mind/model/cosyvoice_train/exp/cosyvoice2/tensorboard/llm \
...
echo "============================================================"
echo ""
echo "LoRA fine-tuning finished."
echo ""
echo "Check output:"
echo "  ls -lh $EXP_DIR"
echo ""
echo "Next: bash phase5_train_flow.sh"
